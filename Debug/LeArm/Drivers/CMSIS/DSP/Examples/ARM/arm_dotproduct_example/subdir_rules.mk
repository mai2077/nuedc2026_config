...
LeArm/Drivers/CMSIS/DSP/Examples/ARM/arm_dotproduct_example/%.o: ../LeArm/Drivers/CMSIS/DSP/Examples/ARM/arm_dotproduct_example/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
