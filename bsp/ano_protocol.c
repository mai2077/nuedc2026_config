...
#define ANO_FRAME_LENGTH (21U)
#define ANO_DATA_LENGTH (13U)
...
{
    uint8_t frame[ANO_FRAME_LENGTH];
    uint8_t sum = 0U;
    uint8_t add = 0U;
    uint16_t index;
    ...
    for (index = 0U; index < (ANO_FRAME_LENGTH - 2U); ++index) {
    ...
    for (index = 0U; index < ANO_FRAME_LENGTH; ++index) {
